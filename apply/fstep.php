                           ...
                           <table class="table table-striped table-hover table-bordered">
                               ...
                               <tbody>
							     ...
							     ?>
									...
									<?php
										$sqlcheckpayd1=mysql_query("SELECT amount FROM  fbs_payment a,fbs_unit_data b  WHERE a.aid='".mysql_real_escape_string($row['application_id'])."' AND a.pid='".mysql_real_escape_string($rowsdata1['payid'])."' AND b.unitid='1' limit 1");
							     ...
							     ?>
									...
									<th style='text-align:center;'>
									   ...
									   <?php } ?>
										...
										<?php
										$sqlcheckpayd2=mysql_query("SELECT amount FROM  fbs_payment a,fbs_unit_data b  WHERE a.aid='".mysql_real_escape_string($row['application_id'])."' AND a.pid='".mysql_real_escape_string($rowsdata2['payid'])."' AND b.unitid='2' limit 1 ");
							     ...
							     ?>
									...
									<?php
										$sqlcheckpayd3=mysql_query("SELECT amount FROM  fbs_payment a,fbs_unit_data b  WHERE a.aid='".mysql_real_escape_string($row['application_id'])."' AND a.pid='".mysql_real_escape_string($rowsdata3['payid'])."' AND b.unitid='3' limit 1");
