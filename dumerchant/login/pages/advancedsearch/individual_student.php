...
<script>
   ...
   function fn_data_search(){
	        if(fn_validation('collegename*subname*nureg')==0) return;
	        $('#htmlview').html('<font color="red"><b>Please wait data is now processing..</a></font>');
	        var college=$('#collegename').val();
	        var sub=$('#subname').val();
	        var nureg=$('#nureg').val();
			var data ="action=viewdata&college="+college+"&sub="+sub+"&nureg="+nureg;
			//alert(data); return;
			http.open( "POST","pages/advancedsearch/individual_student_serach.php",true);
         ...
         <div class="widget">
							...
							<div class="panel panel-primary">
												<div class="panel-heading">
													<h3 class="panel-title" style="color:white;"> <span class='glyphicon glyphicon-search'></span> Individual Student Search </h3>
												</div>
													...
													<table class="table table-striped table-bordered table-hover table-responsive">
														 <tr>
														  ...
														  <tr>
															...
															<td>
															     <input type='text' name="nureg"  class="form-control" id="nureg" />
															</td>
