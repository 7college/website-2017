...
include('../process/common_function.php');
         ...
         <div class="page">
          ...
          <table width="100%">
             <tr>
               ...
               <img src="../images/logo.jpg" style="width:90px; height:100px; margin:0px;padding-left:140px;" />
               </td>
              <td width="100%" align="right" onclick="myFunction()" id='hide'> <img src="../images/print.png" style="width:40px; height:40px; margin:0px; padding:0px;" /> </td>
             ...
             <tr style="margin:0px; padding:0px;"">
               ...
               <td width="60%" align="center">
                   <h4 style='font-weight:bolder;'>
                      সমাজ সেবা অধিদপ্তর<br />
					  <span style='font-size:14px;'>
                       পদের নাম : <?php  echo $PostArray[$row['nop']]; ?><br />
                      <u> আবেদন কপি </u>
					 </span>
                 </h4>
               </td>
