	<script type="text/javascript">
     function fnc_save_Info()
	 {
        ...
        if(fn_validation('center_name')==0) return;
		var center_name=$('#center_name').val();
		//var capasity=$('#capasity').val();
		var systemID=$('#systemID').val();
		var data ="action=save_update_delete&center_name="+center_name+'&systemID='+systemID;
		//alert
		http.open( "POST","pages/center/include/manage_center_controller.php",true);
	...
	function fnc_data_save_response()
	{
		...
		{ 
		  ...
		  window.location='index.php?data=center/collegename';
		  return;
		  } 
   }
    ...
    <div class="container">
      <div class="row">
       ...
       <div class="col-md-12" style="padding:0px; margin:0px;">
		...
		<h3 class="panel-title" style="color:white;"> Department Setup</h3>
		</div>
