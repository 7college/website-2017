	...
	<script type="text/javascript">
     ...
     function fnc_dataSearch()
	 {
       ...
       if(fn_validation('centerName*room_no')==0) return;
	    var room_no=$('#room_no').val();
		var data ="action=save_update_delete&room_no="+room_no;
		http.open( "POST","report/exam_attendence_sheet_report.php",true);
                ...
                <div class="col-md-12" style="margin:0px; padding:0px;">
                    ...
                    <div class="panel panel-default" style="margin:0px; padding:0px;">
                        <div class="panel-heading">
                              <span class="fa fa-list-ul"></span> Generate Attendence Sheet 
                        </div>
                        </br>
