	...
	<?php 
        $sql2=mysql_query("select count(id) from student_info_fbs");
                ...
                <div class="col-md-12" style="margin:0px; padding:0px;">
                    ...
                    <div class="panel panel-default" style="margin:0px; padding:0px;">
                        <div class="panel-heading">
                              <span class="glyphicon glyphicon-th"></span> All Valid/ Invalid Data List
                        </div>
                        </br>
                      ...
                      <table class="table table-striped table-bordered table-hover table-responsive" width="100%">
                                ...
                                <tr style="font-size:10px;">
                                  ...
                                  <tbody>
                                    <?php
                                    $i=1; 
                                    $sql=mysql_query("select * from student_info_fbs order by id ASC $limit") or die(); 
