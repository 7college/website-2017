...
function fnc_sytem(){
	...
	http.open( "POST","pages/sms/include/gratuate_report_sms_semester.php",true);
          ...
          <div class="smsmis">
            ...
            <table class="table table-striped table-bordered table-hover table-responsive" width="100%" border="1"  id="data_load_list">
              ...
              <tr>
                ...
                $sqlBatch= mysql_query("SELECT * FROM  fbs_semester");
                while($row=mysql_fetch_assoc($sqlBatch)){
                ?>
                    <option value="<?php echo $row['id']; ?>"><?php echo $row['semester_title']; ?></option>
                    <?php  } ?>
                  </select></td>
